...
<body>
  ...
  <ul>
	...
	<li><a href="http://localhost/mywebsite/reportview.php">Check report</a></li>
		...
		<form class="form" action="DELE.php">
			<br><br>
			<h3 class="head">Student Course Offering</h3>
  <br>Student ID:<br><br>
  <input type="text" name="student id">
  <br><br>
  <input type="submit" value="View">  
<button ><a href="search.php" class="A">Search</a></button>
     <button><a href="reportview.php" class="A">Report</a></button></form>	
